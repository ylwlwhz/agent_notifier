...
| **statusLine** | Status-bar model, effort, per-rate-limit-window spend/quota/reset and context use + `cost-capture.js` feeding official metrics to completion cards | `install.sh` wires up cross-platform `scripts/statusline.sh` |
